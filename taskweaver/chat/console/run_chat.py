...
def chat_taskweaver(user_query: str = "", app_dir: Optional[str] = None, ran_str: Optional[str] = None):
    app = TaskWeaverApp(app_dir=app_dir, use_local_uri=True)
    session = app.get_session(ran_str=ran_str)
    ...
    return session.session_id, response[0]
